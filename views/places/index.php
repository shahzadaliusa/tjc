                                ...
                                foreach($data as $key=>$val){
                                    echo '<div class="caro-card caro-inline">
                                        <a href="'.HOME.'zones/'.$val['in_zone_name'].'" class="caro-card-anchor">
                                            <div class="card-img"><img class="owl-lazy" data-src="'.URL."img/zones/".$val['in_zone_name'].'/thumbs/'.$val['in_zone_name'].'.jpg" width="100%"></div>
                                            <div class="card-info">
                            ...
                            foreach($data as $key=>$val){
                                echo '<div class="caro-card caro-inline">
                                    <a href="'.HOME.'places/'.$val['in_place_name'].'" class="caro-card-anchor">
                                        <div class="card-img"><img class="owl-lazy" data-src="'.URL."img/places/".$val['in_place_zone'].'/'.$val['in_place_name'].'/thumbs/'.$val['in_place_name'].'.jpg" width="100%"></div>
                                        <div class="card-info">
